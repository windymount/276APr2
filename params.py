...
IMG_OUTPUT_PATH = "img-scaled-update"
CORRELATION_SEARCHGRID_SIZE = 1.2
CORRELATION_SEARCHGRID_NUM = 9
UPDATE_SCALE_FACTOR = 0.002
UPDATE_INTERVAL = 10
MAPPING_INTERVAL = 1